...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Nexora Tools - Premium Online Tools',
    description: 'Tools online cepat, praktis, dan siap dipakai.',
    url: siteUrl,
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="id" className="dark">
      <body className="min-h-screen flex flex-col bg-[#050505] text-zinc-100 antialiased [font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe_UI',sans-serif]">
